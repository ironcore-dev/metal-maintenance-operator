...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DellFirmwareRepository) DeepCopyInto(out *DellFirmwareRepository) {
	*out = *in
	...
	if in.ApplyVersionPolicy != nil {
		in, out := &in.ApplyVersionPolicy, &out.ApplyVersionPolicy
		*out = new(DellVersionApplyPolicy)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DellFirmwareRepository.
func (in *DellFirmwareRepository) DeepCopy() *DellFirmwareRepository {
	if in == nil {
		return nil
	}
	out := new(DellFirmwareRepository)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FirmwareUpdateTemplate) DeepCopyInto(out *FirmwareUpdateTemplate) {
	*out = *in
	if in.DellRepository != nil {
		in, out := &in.DellRepository, &out.DellRepository
		*out = new(DellFirmwareRepository)
		(*in).DeepCopyInto(*out)
	}
	if in.ServerMaintenancePolicy != nil {
