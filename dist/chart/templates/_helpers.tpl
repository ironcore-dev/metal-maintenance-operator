...
*/}}
{{- define "metal-maintenance-operator.name" -}}
...
*/}}
{{- define "metal-maintenance-operator.fullname" -}}
...
*/}}
{{- define "metal-maintenance-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "metal-maintenance-operator.resourceName" -}}
{{- $fullname := include "metal-maintenance-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "metal-maintenance-operator.serviceAccountName" -}}
{{- if .Values.serviceAccount.enabled }}
{{- include "metal-maintenance-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- else }}
