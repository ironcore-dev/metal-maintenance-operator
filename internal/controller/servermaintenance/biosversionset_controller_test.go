...
var _ = Describe("BIOSVersionSet Controller", func() {
	...
	It("should successfully reconcile the resource", func(ctx SpecContext) {
		By("Created resource")
		biosVersionSet := &servermaintenancev1alpha1.BIOSVersionSet{
			ObjectMeta: metav1.ObjectMeta{
				GenerateName: "test-biosversion-set-",
			},
			Spec: servermaintenancev1alpha1.BIOSVersionSetSpec{
		...
		biosVersion02 := &servermaintenancev1alpha1.BIOSVersion{
			ObjectMeta: metav1.ObjectMeta{
		...
		biosVersion03 := &servermaintenancev1alpha1.BIOSVersion{
			ObjectMeta: metav1.ObjectMeta{
		...
		Eventually(Object(biosVersion02)).Should(SatisfyAll(
			HaveField("Status.State", servermaintenancev1alpha1.BIOSVersionStateCompleted),
	...
	It("should successfully reconcile the resource when BMC are deleted/created", func(ctx SpecContext) {
		...
		biosVersion01 := &servermaintenancev1alpha1.BIOSVersion{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("Should successfully retry failed state child resources", func(ctx SpecContext) {
		...
		Eventually(Object(biosVersion02)).Should(SatisfyAll(
			HaveField("Status.State", servermaintenancev1alpha1.BIOSVersionStateFailed),
		...
		Eventually(Object(biosVersion02)).Should(SatisfyAll(
			HaveField("Status.State", Not(Equal(servermaintenancev1alpha1.BIOSVersionStateFailed))),
