...
var _ = Describe("BIOSSettingsSet Controller", func() {
	...
	It("should successfully reconcile the resource", func(ctx SpecContext) {
		...
		biosSettingsSet := &servermaintenancev1alpha1.BIOSSettingsSet{
			...
			Spec: servermaintenancev1alpha1.BIOSSettingsSetSpec{
		...
		biosSettings02 := &servermaintenancev1alpha1.BIOSSettings{
			ObjectMeta: metav1.ObjectMeta{
		...
		biosSettings03 := &servermaintenancev1alpha1.BIOSSettings{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("should successfully reconcile the resource when servers are deleted/created", func(ctx SpecContext) {
		...
		biosSettings01 := &servermaintenancev1alpha1.BIOSSettings{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("should successfully wait and reconcile until all resources are updated", func(ctx SpecContext) {
		...
		biosSettingsSet1 := &servermaintenancev1alpha1.BIOSSettingsSet{
			ObjectMeta: metav1.ObjectMeta{
		...
		biosSettingsSet2 := &servermaintenancev1alpha1.BIOSSettingsSet{
			ObjectMeta: metav1.ObjectMeta{
		...
		biosSettings02_02 := &servermaintenancev1alpha1.BIOSSettings{
			ObjectMeta: metav1.ObjectMeta{
		...
		By("Checking if the 2nd BIOSSettings has been created")
		biosSettings03_02 := &servermaintenancev1alpha1.BIOSSettings{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("Should successfully retry failed state child resources", func(ctx SpecContext) {
		...
		Eventually(Object(biosSettings02)).WithPolling(1 * time.Millisecond).Should(SatisfyAll(
			HaveField("Status.State", Not(Equal(servermaintenancev1alpha1.BIOSSettingsStateFailed))),
