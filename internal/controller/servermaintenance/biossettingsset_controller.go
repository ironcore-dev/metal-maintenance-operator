...
const (
	biosSettingsSetFinalizer = "servermaintenance.metal.ironcore.dev/biossettingsset"
)
...
// +kubebuilder:rbac:groups=servermaintenance.metal.ironcore.dev,resources=biossettingssets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=servermaintenance.metal.ironcore.dev,resources=biossettingssets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=servermaintenance.metal.ironcore.dev,resources=biossettingssets/finalizers,verbs=update
...
func (r *BIOSSettingsSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	biosSettingsSet := &servermaintenancev1alpha1.BIOSSettingsSet{}
...
func (r *BIOSSettingsSetReconciler) reconcileExists(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) (ctrl.Result, error) {
...
func (r *BIOSSettingsSetReconciler) delete(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) (ctrl.Result, error) {
...
func (r *BIOSSettingsSetReconciler) handleIgnoreAnnotationPropagation(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) error {
	log := ctrl.LoggerFrom(ctx)
	ownedBiosSettings, err := r.getOwnedBIOSSettings(ctx, set)
	if err != nil {
		return err
...
func (r *BIOSSettingsSetReconciler) handleRetryAnnotationPropagation(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) error {
	log := ctrl.LoggerFrom(ctx)
	ownedBiosSettings, err := r.getOwnedBIOSSettings(ctx, set)
	if err != nil {
		return err
...
func (r *BIOSSettingsSetReconciler) reconcile(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BIOSSettingsSetReconciler) handleBIOSSettings(ctx context.Context, servers *metalv1alpha1.ServerList, set *servermaintenancev1alpha1.BIOSSettingsSet) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
	ownedBiosSettings, err := r.getOwnedBIOSSettings(ctx, set)
	if err != nil {
		return ctrl.Result{}, err
...
func (r *BIOSSettingsSetReconciler) createMissingBIOSSettings(ctx context.Context, servers *metalv1alpha1.ServerList, settings *servermaintenancev1alpha1.BIOSSettingsList, set *servermaintenancev1alpha1.BIOSSettingsSet) error {
	log := ctrl.LoggerFrom(ctx)
	...
	for _, server := range servers.Items {
		if _, ok := serverWithSettings[server.Name]; !ok {
			if server.Spec.BIOSSettingsRef != nil {
				if err := r.Get(ctx, client.ObjectKey{Name: server.Spec.BIOSSettingsRef.Name}, &servermaintenancev1alpha1.BIOSSettings{}); err != nil {
			...
			var newBiosSetting *servermaintenancev1alpha1.BIOSSettings
			if len(newBiosSettingsName) > utilvalidation.DNS1123SubdomainMaxLength {
				...
				newBiosSetting = &servermaintenancev1alpha1.BIOSSettings{
...
func (r *BIOSSettingsSetReconciler) deleteOrphanBIOSSettings(ctx context.Context, servers *metalv1alpha1.ServerList, settings *servermaintenancev1alpha1.BIOSSettingsList) error {
	log := ctrl.LoggerFrom(ctx)
	...
	for _, biosSettings := range settings.Items {
		if _, ok := serverMap[biosSettings.Spec.ServerRef.Name]; !ok {
			if biosSettings.Status.State == servermaintenancev1alpha1.BIOSSettingsStateInProgress && biosSettings.Spec.ServerMaintenanceRef != nil {
				active, err := utils.IsAnyServerMaintenanceActive(ctx, r.Client, []metalv1alpha1.ObjectReference{*biosSettings.Spec.ServerMaintenanceRef})
				if err != nil {
...
func (r *BIOSSettingsSetReconciler) patchBIOSSettingsFromTemplate(ctx context.Context, template *servermaintenancev1alpha1.BIOSSettingsTemplate, settingsList *servermaintenancev1alpha1.BIOSSettingsList) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BIOSSettingsSetReconciler) getOwnedBIOSSettingsSetStatus(settingsList *servermaintenancev1alpha1.BIOSSettingsList) *servermaintenancev1alpha1.BIOSSettingsSetStatus {
	status := &servermaintenancev1alpha1.BIOSSettingsSetStatus{}
...
func (r *BIOSSettingsSetReconciler) getOwnedBIOSSettings(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) (*servermaintenancev1alpha1.BIOSSettingsList, error) {
...
func (r *BIOSSettingsSetReconciler) getServersBySelector(ctx context.Context, set *servermaintenancev1alpha1.BIOSSettingsSet) (*metalv1alpha1.ServerList, error) {
...
func (r *BIOSSettingsSetReconciler) patchStatus(ctx context.Context, status *servermaintenancev1alpha1.BIOSSettingsSetStatus, set *servermaintenancev1alpha1.BIOSSettingsSet) error {
...
func (r *BIOSSettingsSetReconciler) enqueueByServer(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	setList := &servermaintenancev1alpha1.BIOSSettingsSetList{}
...
func (r *BIOSSettingsSetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&servermaintenancev1alpha1.BIOSSettingsSet{}).
		Owns(&servermaintenancev1alpha1.BIOSSettings{}).
