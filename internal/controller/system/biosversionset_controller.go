...
const (
	BIOSVersionSetFinalizer = "system.metal.ironcore.dev/biosversionset"
)
...
// +kubebuilder:rbac:groups=system.metal.ironcore.dev,resources=biosversionsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=system.metal.ironcore.dev,resources=biosversionsets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=system.metal.ironcore.dev,resources=biosversionsets/finalizers,verbs=update
...
func (r *BIOSVersionSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	versionSet := &systemv1alpha1.BIOSVersionSet{}
...
func (r *BIOSVersionSetReconciler) reconcileExists(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) (ctrl.Result, error) {
...
func (r *BIOSVersionSetReconciler) delete(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) (ctrl.Result, error) {
...
func (r *BIOSVersionSetReconciler) handleIgnoreAnnotationPropagation(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) error {
	log := ctrl.LoggerFrom(ctx)
	versions, err := r.getOwnedBIOSVersions(ctx, versionSet)
	if err != nil {
		return err
...
func (r *BIOSVersionSetReconciler) handleRetryAnnotationPropagation(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) error {
	log := ctrl.LoggerFrom(ctx)
	versions, err := r.getOwnedBIOSVersions(ctx, versionSet)
	if err != nil {
		return err
...
func (r *BIOSVersionSetReconciler) reconcile(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BIOSVersionSetReconciler) ensureBIOSVersionsForServers(ctx context.Context, servers *metalv1alpha1.ServerList, versions *systemv1alpha1.BIOSVersionList, versionSet *systemv1alpha1.BIOSVersionSet) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BIOSVersionSetReconciler) deleteOrphanBIOSVersions(ctx context.Context, servers *metalv1alpha1.ServerList, versions *systemv1alpha1.BIOSVersionList) error {
	log := ctrl.LoggerFrom(ctx)
	...
	for _, biosVersion := range versions.Items {
		if !serverMap[biosVersion.Spec.ServerRef.Name] {
			if biosVersion.Status.State == systemv1alpha1.BIOSVersionStateInProgress && biosVersion.Spec.ServerMaintenanceRef != nil {
...
func (r *BIOSVersionSetReconciler) patchBIOSVersionFromTemplate(ctx context.Context, template *systemv1alpha1.BIOSVersionTemplate, versions *systemv1alpha1.BIOSVersionList) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
	if len(versions.Items) == 0 {
	...
	var errs []error
	for _, version := range versions.Items {
		if version.Status.State == systemv1alpha1.BIOSVersionStateInProgress {
...
func (r *BIOSVersionSetReconciler) getOwnedBIOSVersionSetStatus(versionList *systemv1alpha1.BIOSVersionList) *systemv1alpha1.BIOSVersionSetStatus {
	status := &systemv1alpha1.BIOSVersionSetStatus{}
...
func (r *BIOSVersionSetReconciler) getOwnedBIOSVersions(ctx context.Context, versionSet *systemv1alpha1.BIOSVersionSet) (*systemv1alpha1.BIOSVersionList, error) {
...
func (r *BIOSVersionSetReconciler) getServersBySelector(ctx context.Context, set *systemv1alpha1.BIOSVersionSet) (*metalv1alpha1.ServerList, error) {
...
func (r *BIOSVersionSetReconciler) patchStatus(ctx context.Context, status *systemv1alpha1.BIOSVersionSetStatus, versionSet *systemv1alpha1.BIOSVersionSet) error {
...
func (r *BIOSVersionSetReconciler) enqueueByServer(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	setList := &systemv1alpha1.BIOSVersionSetList{}
...
func (r *BIOSVersionSetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&systemv1alpha1.BIOSVersionSet{}).
		Owns(&systemv1alpha1.BIOSVersion{}).
