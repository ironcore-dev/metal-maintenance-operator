...
var _ = Describe("BMCSettingsSet Controller", func() {
	...
	It("should successfully reconcile when BMCSettingsSet was generated, labels match and BMCSettings were generated", func(ctx SpecContext) {
		...
		bmcSettings01 := &bmcmaintenancev1alpha1.BMCSettings{
			ObjectMeta: metav1.ObjectMeta{
		...
		Eventually(Object(bmcSettings01)).Should(SatisfyAll(
			...
			HaveField("OwnerReferences", ContainElement(metav1.OwnerReference{
				APIVersion:         "bmcmaintenance.metal.ironcore.dev/v1alpha1",
				Kind:               "BMCSettingsSet",
		...
		bmcSettings02 := &bmcmaintenancev1alpha1.BMCSettings{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("should successfully reconcile when BMCSettingsSet was updated", func(ctx SpecContext) {
		...
		Eventually(Object(bmcSettings01)).Should(HaveField("Status.State", Equal(bmcmaintenancev1alpha1.BMCSettingsStateApplied)))
	...
	It("should successfully wait and reconcile until all resources are updated", func(ctx SpecContext) {
		...
		bmcSettingsSet1 := &bmcmaintenancev1alpha1.BMCSettingsSet{
			ObjectMeta: metav1.ObjectMeta{
				GenerateName: "test1-"},
			Spec: bmcmaintenancev1alpha1.BMCSettingsSetSpec{
				BMCSettingsTemplate: bmcmaintenancev1alpha1.BMCSettingsTemplate{
		...
		bmcSettingsSet2 := &bmcmaintenancev1alpha1.BMCSettingsSet{
			ObjectMeta: metav1.ObjectMeta{
				GenerateName: "test2-"},
			Spec: bmcmaintenancev1alpha1.BMCSettingsSetSpec{
				BMCSettingsTemplate: bmcmaintenancev1alpha1.BMCSettingsTemplate{
		...
		bmcSettings01_02 := &bmcmaintenancev1alpha1.BMCSettings{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("Should successfully retry failed state child resources", func(ctx SpecContext) {
		...
		Eventually(Object(bmcSettings01)).Should(SatisfyAll(
			HaveField("Status.State", bmcmaintenancev1alpha1.BMCSettingsStateFailed),
