...
const (
	bmcVersionFinalizer = "bmcmaintenance.metal.ironcore.dev/bmcversion"
)
...
// +kubebuilder:rbac:groups=bmcmaintenance.metal.ironcore.dev,resources=bmcversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bmcmaintenance.metal.ironcore.dev,resources=bmcversions/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=bmcmaintenance.metal.ironcore.dev,resources=bmcversions/finalizers,verbs=update
...
func (r *BMCVersionReconciler) reconcileExists(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (ctrl.Result, error) {
...
func (r *BMCVersionReconciler) shouldDelete(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (bool, error) {
	isProgressing := func() (bool, error) {
		if bmcVersion.Status.State != bmcmaintenancev1alpha1.BMCVersionStateInProgress {
			return false, nil
		}
...
func (r *BMCVersionReconciler) delete(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCVersionReconciler) removeServerMaintenances(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCVersionReconciler) reconcile(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCVersionReconciler) ensureBMCVersionStateTransition(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
	...
	case "", bmcmaintenancev1alpha1.BMCVersionStatePending:
	...
	case bmcmaintenancev1alpha1.BMCVersionStateInProgress:
	...
	case bmcmaintenancev1alpha1.BMCVersionStateCompleted:
		return ctrl.Result{}, r.removeServerMaintenanceRefAndResetConditions(ctx, bmcVersion, bmcClient, bmcObj)
	case bmcmaintenancev1alpha1.BMCVersionStateFailed:
...
func (r *BMCVersionReconciler) handleUpgradeInProgressState(
	...
	if condition.Status != metav1.ConditionTrue {
		...
		err = r.patchBMCVersionStatusAndCondition(
			ctx,
			bmcVersion,
			bmcmaintenancev1alpha1.BMCVersionStateCompleted,
...
func (r *BMCVersionReconciler) handleFailedState(
	...
	if utils.ShouldRetryReconciliation(bmcVersion) {
		...
		bmcVersion.Status.State = bmcmaintenancev1alpha1.BMCVersionStatePending
...
func (r *BMCVersionReconciler) checkIfMaintenanceGranted(ctx context.Context, bmcClient bmc.BMC, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) bool {
	log := ctrl.LoggerFrom(ctx)
	// todo length
...
func (r *BMCVersionReconciler) removeServerMaintenanceRefAndResetConditions(
	...
	state := bmcmaintenancev1alpha1.BMCVersionStateInProgress
	if currentBMCVersion == bmcVersion.Spec.Version {
		...
		state = bmcmaintenancev1alpha1.BMCVersionStateCompleted
	}
...
func (r *BMCVersionReconciler) resetBMC(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion, bmcObj *metalv1alpha1.BMC, conditionType string) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCVersionReconciler) getBMCFromBMCVersion(ctx context.Context, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (*metalv1alpha1.BMC, error) {
	if bmcVersion.Spec.BMCRef == nil {
...
func (r *BMCVersionReconciler) requestMaintenanceOnServers(ctx context.Context, bmcClient bmc.BMC, bmcVersion *bmcmaintenancev1alpha1.BMCVersion) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
	servers, err := r.getServersForBMCVersion(ctx, bmcClient, bmcVersion)
	if err != nil {
...
func (r *BMCVersionReconciler) checkBMCUpgradeStatus(
	...
	if taskCurrentStatus.TaskState == schemas.KilledTaskState ||
		...
		err = r.patchBMCVersionStatusAndCondition(
			ctx,
			bmcVersion,
			bmcmaintenancev1alpha1.BMCVersionStateFailed,
...
func (r *BMCVersionReconciler) issueBMCUpgrade(
	...
	if errCond = r.Conditions.Update(
		...
		if errCond = r.Conditions.Update(
			...
			state = bmcmaintenancev1alpha1.BMCVersionStateFailed
...
func (r *BMCVersionReconciler) enqueueBMCVersionByServerRefs(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	for _, bmcVersion := range bmcVersionList.Items {
		...
		if bmcVersion.Status.State == bmcmaintenancev1alpha1.BMCVersionStateCompleted || bmcVersion.Status.State == bmcmaintenancev1alpha1.BMCVersionStateFailed {
			continue
		}
