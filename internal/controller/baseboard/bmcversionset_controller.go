...
const (
	BMCVersionSetFinalizer = "baseboard.metal.ironcore.dev/bmcversionset"
)
...
// +kubebuilder:rbac:groups=baseboard.metal.ironcore.dev,resources=bmcversionsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=baseboard.metal.ironcore.dev,resources=bmcversionsets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=baseboard.metal.ironcore.dev,resources=bmcversionsets/finalizers,verbs=update
...
func (r *BMCVersionSetReconciler) deleteOrphanBMCVersions(
	...
	for _, bmcVersion := range bmcVersionList.Items {
		if _, ok := bmcMap[bmcVersion.Spec.BMCRef.Name]; !ok {
			if bmcVersion.Status.State == baseboardv1alpha1.BMCVersionStateInProgress && len(bmcVersion.Spec.ServerMaintenanceRefs) > 0 {
...
func (r *BMCVersionSetReconciler) patchBMCVersionfromTemplate(
	...
	var errs []error
	for _, bmcVersion := range bmcVersionList.Items {
		if bmcVersion.Status.State == baseboardv1alpha1.BMCVersionStateInProgress && bmcVersion.Status.UpgradeTask != nil {
...
func (r *BMCVersionSetReconciler) getOwnedBMCVersionSetStatus(
	bmcVersionList *baseboardv1alpha1.BMCVersionList,
) *baseboardv1alpha1.BMCVersionSetStatus {
	currentStatus := &baseboardv1alpha1.BMCVersionSetStatus{}
...
func (r *BMCVersionSetReconciler) getOwnedBMCVersions(
	ctx context.Context,
	bmcVersionSet *baseboardv1alpha1.BMCVersionSet,
) (*baseboardv1alpha1.BMCVersionList, error) {
	bmcVersionList := &baseboardv1alpha1.BMCVersionList{}
...
func (r *BMCVersionSetReconciler) enqueueByBMC(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	bmcVersionSetList := &baseboardv1alpha1.BMCVersionSetList{}
...
func (r *BMCVersionSetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&baseboardv1alpha1.BMCVersionSet{}).
		Watches(
			&baseboardv1alpha1.BMCVersion{},
			handler.EnqueueRequestForOwner(r.Scheme, r.RESTMapper(), &baseboardv1alpha1.BMCVersionSet{}),
