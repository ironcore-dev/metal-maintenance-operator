...
const (
	bmcUserFinalizer = "bmc.metal.ironcore.dev/bmcuser"
)
...
// +kubebuilder:rbac:groups=bmc.metal.ironcore.dev,resources=bmcusers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bmc.metal.ironcore.dev,resources=bmcusers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=bmc.metal.ironcore.dev,resources=bmcusers/finalizers,verbs=update
...
func (r *BMCUserReconciler) reconcileExists(ctx context.Context, user *bmcv1alpha1.BMCUser) (ctrl.Result, error) {
...
func (r *BMCUserReconciler) reconcile(ctx context.Context, user *bmcv1alpha1.BMCUser) (ctrl.Result, error) {
...
func (r *BMCUserReconciler) patchUserStatus(ctx context.Context, user *bmcv1alpha1.BMCUser, bmcClient bmc.BMC, lastRotation metav1.Time) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) handleRotatingPassword(ctx context.Context, user *bmcv1alpha1.BMCUser, bmcObj *metalv1alpha1.BMC, bmcClient bmc.BMC) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
	forceRotation := false
...
func (r *BMCUserReconciler) ensureBMCSecretForUser(ctx context.Context, bmcClient bmc.BMC, user *bmcv1alpha1.BMCUser, bmcObj *metalv1alpha1.BMC) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) handleUpdatedSecretRef(ctx context.Context, user *bmcv1alpha1.BMCUser, bmcSecret *metalv1alpha1.BMCSecret, bmcClient bmc.BMC) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) createBMCSecretForUser(ctx context.Context, user *bmcv1alpha1.BMCUser, password string) (*metalv1alpha1.BMCSecret, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) setBMCUserSecretRef(ctx context.Context, user *bmcv1alpha1.BMCUser, secret *metalv1alpha1.BMCSecret) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) setEffectiveSecretRef(ctx context.Context, user *bmcv1alpha1.BMCUser, secret *metalv1alpha1.BMCSecret) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) updateEffectiveSecret(ctx context.Context, user *bmcv1alpha1.BMCUser, bmcObj *metalv1alpha1.BMC) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *BMCUserReconciler) delete(ctx context.Context, user *bmcv1alpha1.BMCUser) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
	if user.Spec.BMCRef == nil {
